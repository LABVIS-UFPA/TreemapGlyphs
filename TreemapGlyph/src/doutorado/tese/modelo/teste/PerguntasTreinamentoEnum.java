...
public enum PerguntasTreinamentoEnum {
    ...
    Q2("Encontre os carros de maior VALOR, o de maior POTENCIA e o de maior PESO movidos à GASOLINA;"),//categorica e continua
    Q3("Encontre o único carro do TIPO SUV."),//categorica
    Q4("Localize os carros de maior RPM, o de maior VALOR e o de maior POTENCIA;"),//categorica e continua
