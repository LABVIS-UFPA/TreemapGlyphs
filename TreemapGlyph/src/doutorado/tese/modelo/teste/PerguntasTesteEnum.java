...
public enum PerguntasTesteEnum {
    Q1("Localize a região em que houve o registro de apenas uma chuva ácida."),//categorica
    ...
    Q4("No registro de ocorrência de furação no nordeste, descubra se o alerta da defesa civil foi ativado."),//categorica
    ...
    Q6("Na região norte, encontre os registros de furacões que ativaram a defesa civil com chuva de PH básico e temperatura baixa."),//categorica
    ...
    Q10("Na região Norte, durante o outono na localidade rural, selecione o único registro de maior volume de chuva e menor intensidade de vento."),//categorica e continua
    Q11("Selecione o único registro da região norte, com temperatura média, que possui ph da chuva elevado e média da umidade do ar baixa."),//categorica e continua
