 ...
 */
public class CategoricalFilterSetUp extends javax.swing.JFrame {

    /**
     * Creates new form FilterSetUp
     */
    public CategoricalFilterSetUp() {
        initComponents();
    ...
    private void initComponents() {
        ...
        fundoPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Categorical filter"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategoricalFilterSetUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CategoricalFilterSetUp().setVisible(true);
            }
        });
    }
