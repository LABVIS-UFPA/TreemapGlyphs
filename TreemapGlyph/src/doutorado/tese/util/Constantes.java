...
public class Constantes {
    ...
    public static final int NUM_CAMADAS = 7;
    public static final int FEATURE_ALTURA = 8;
    public static final int FEATURE_LARGURA = 9;
    public static final int FEATURE_AREA = 10;//TIA - TOTAL ITEM AREA
    public static final int FEATURE_ASPECT = 11;
    public static final int PRESENCA_COR_TREEMAP = 12;//
    public static final int AREA_TEXTURA = 13;//TA - TEXTURE AREA
    public static final int AREA_COR = 14;//CCA - Colored circle area
    public static final int AREA_SHAPE = 15;//SA - SHAPE AREA
    public static final int AREA_TEXTO = 16;
    public static final int AREA_POSICAO = 17;//NA - NUMBER AREA
    public static final int AREA_ORIENTACAO = 18;//NA - NUMBER AREA
    public static final int AREA_PROFILE_GLYPH = 19;//NA - NUMBER AREA
    public static final int AREA_VISIVEL_SHAPE = 20;
    public static final int AREA_VISIVEL_TEXTURE = 21;
    public static final int AREA_VISIVEL_TEXT = 22;
    public static final int AREA_VISIVEL_POSICAO = 23;
    public static final int AREA_VISIVEL_ORIENTACAO = 24;
