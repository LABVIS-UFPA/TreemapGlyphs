...
public class Arrow45 implements DrawBehavior {
    ...
    private void montarSetas45() {
        ...
        montarRetas(slice);
        montarTriangulo(scalewidth);

        drawSetas();
    }

    private void montarTriangulo(int scaleheight) {
        int x = 0;
        int y = 0;
        while (x <= xPoints[0] + xPoints[1]) {
            if (x > 0 && x < 5 * scaleheight) {
                Polygon p = new Polygon();
                p.addPoint(xPoints[0] + x, yPoints[0]);
                //top
                p.addPoint((int) (xPoints[0] + x - scaleheight * 1.25), (int) (yPoints[0] + scaleheight * 0.7));
                //botton
                p.addPoint((int) (xPoints[0] + x - scaleheight * 0.6), (int) (yPoints[0] + scaleheight * 1.4));
        ...
        while (y < yPoints[0] + yPoints[1]) {
            if (y < 5 * scaleheight) {
                Polygon p = new Polygon();
                p.addPoint(xPoints[0] + xPoints[1], yPoints[0] + y);
                //top
                p.addPoint((int) (xPoints[0] + xPoints[1] - scaleheight * 1.25), (int) (yPoints[0] + y + scaleheight * 0.7));
                //botton
                p.addPoint((int) (xPoints[0] + xPoints[1] - scaleheight * 0.6), (int) (yPoints[0] + y + scaleheight * 1.4));
    ...
    private void montarRetas(int slice) {
        ...
        line1[2] = xPoints[0] + 2 * slice;
        line1[3] = yPoints[0];

        int[] line2 = new int[4];
        line2[0] = xPoints[0];
        line2[1] = yPoints[0] + 4 * slice;
        line2[2] = xPoints[0] + 4 * slice;
        line2[3] = yPoints[0];

        int[] line3 = new int[4];
        line3[0] = xPoints[0];
        line3[1] = yPoints[0] + yPoints[1];
        line3[2] = xPoints[0] + xPoints[1];
        line3[3] = yPoints[0];
        
        int[] line4 = new int[4];
        line4[0] = xPoints[0] + 2 * slice;
        line4[1] = yPoints[0] + yPoints[1];
        line4[2] = xPoints[0] + xPoints[1];
        line4[3] = yPoints[0] + 2 * slice;
        
        int[] line5 = new int[4];
        line5[0] = xPoints[0] + 4 * slice;
        line5[1] = yPoints[0] + yPoints[1];
        line5[2] = xPoints[0] + xPoints[1];
