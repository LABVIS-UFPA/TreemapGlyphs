 ...
 */
public class CirculoTextura_6x6 implements DrawBehavior {
...
//                p.append(new Ellipse2D.Double(width * 0.025 + i, height * 0.025 + j, textureWidth / 6, textureHeight / 6), false);
//            }
//        }
//
//    }
    ...
    @Override
    public CirculoTextura_6x6 clone() throws CloneNotSupportedException {
        try {
            // call clone in Object.
            return (CirculoTextura_6x6) super.clone();
    ...
    public String toString() {
        super.toString();
        return CirculoTextura_6x6.class.getSimpleName();
    }
}
