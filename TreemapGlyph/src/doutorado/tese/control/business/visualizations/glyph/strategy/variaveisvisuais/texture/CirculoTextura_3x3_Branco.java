 ...
 */
public class CirculoTextura_3x3_Branco implements DrawBehavior {
    ...
    public CirculoTextura_3x3_Branco() {
        corPreenchimento = Color.WHITE;
        corBorda = Color.BLACK;
        corFundo = Color.decode("#dfe5eb");
    }
    ...
    @Override
    public CirculoTextura_3x3_Branco clone() throws CloneNotSupportedException {
        try {
            // call clone in Object.
            return (CirculoTextura_3x3_Branco) super.clone();
    ...
    public String toString() {
        super.toString();
        return CirculoTextura_3x3_Branco.class.getSimpleName();
    }
}
